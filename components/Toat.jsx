...
export default function Toat({ msg, handlShow, bgColor }) {
  return (
    <div className="flex flex-col justify-center">
      <div
        className={`bg-blue-600 shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3 ${bgColor}`}
        id="static-example"
        role="alert"
        aria-live="assertive"
        aria-atomic="true"
      ...
      >
        <div
          className={`bg-blue-600 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-blue-500 rounded-t-lg ${bgColor}`}
        >
